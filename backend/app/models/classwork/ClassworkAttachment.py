...
class ClassworkAttachment(Base):
    ...
    classwork_attachment_id: Mapped[int] = Column(Integer, primary_key=True, autoincrement=True)
    ...
    classwork: Mapped["Classwork"] = relationship("Classwork", back_populates="attachments")
