...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex shrink-0 flex-col gap-1 border-b-2 border-border px-5 py-4", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex shrink-0 flex-col-reverse gap-2 border-t-2 border-border bg-background px-5 py-4 sm:flex-row sm:items-center sm:justify-end", className)}
      {...props}
    />
  )
}
