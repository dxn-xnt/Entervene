...
const Switch = ({ className, ...props }: SwitchPrimitives.SwitchProps) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer border-2 border-foreground outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/35 items-center disabled:cursor-default disabled:opacity-50 data-[state=checked]:bg-primary",
      className,
    )}
    {...props}
  >
