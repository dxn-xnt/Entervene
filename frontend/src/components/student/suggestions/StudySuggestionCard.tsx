...
export default function StudySuggestionCard({
  ...
  return (
    <article className="rounded border border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      <div className="flex flex-col gap-4 p-5 md:flex-row md:items-start md:justify-between">
        <div className="flex min-w-0 flex-1 gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded border border-black bg-[#F6E9B2]">
            <Icon size={21} />
          </div>
          <div className="min-w-0 space-y-2">
            ...
            <div className="rounded border border-gray-300 bg-[#FFFBEE] p-3">
        ...
        <div className="flex shrink-0 flex-wrap gap-2 md:flex-col">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded border border-black bg-white px-4 py-2 text-sm font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-colors hover:bg-[#F6E9B2] disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded border border-black bg-[#7ABA78] px-4 py-2 text-sm font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-colors hover:bg-[#69a967] disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-500"
          >
